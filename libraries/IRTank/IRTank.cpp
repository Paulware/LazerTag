...
PROGMEM prog_uint16_t repairPulses [] = {500, 300, 500, 300, 500, 300, 1000, 300, 1000, 300, 1000, 300, 500, 300, 500, 300 };

// Mini Huan Qi tank
#define MICROHUANQI 5
PROGMEM prog_uint16_t microHuanQi [] = {12840,644,2044,644,672,2016,672,2020,672,2020};
  ...
  switch (fireType)
  {
    ...
    case 6:
      for (int i=0; i<3; i++)
      {
        ...
        {
          myDelay = pgm_read_word_near( microHuanQi + j);
          sendRaw (myDelay, j);
        }
      }
    break;
    ...
    case 0:
      for (int i=0; i<2; i++)
      {
	    if (repairRobot)
		{
          ...
          {
            myDelay = pgm_read_word_near( repairPulses + j);
            sendRaw (myDelay,j);
          }
		}
		else
